...
//      TODO (7) Generate a weather summary with the date, description, high and low
        long lDate = mCursor.getLong(MainActivity.INDEX_WEATHER_DATE);
        String sDate = SunshineDateUtils.getFriendlyDateString(mContext, lDate, false);

        int iDescription = mCursor.getInt(MainActivity.INDEX_WEATHER_ID);
        String sDescription = SunshineWeatherUtils.getStringForWeatherCondition(mContext, iDescription);
...
//      TODO (8) Display the summary that you created above
        String weatherSummary = sDate + " - " + sDescription + " - " + highLowTemperature;
